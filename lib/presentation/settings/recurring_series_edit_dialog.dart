...
class RecurringSeriesEditDialog extends ConsumerStatefulWidget {
  const RecurringSeriesEditDialog({super.key, required this.series});

  final ExpenseRecurringSeries series;

  @override
  ConsumerState<RecurringSeriesEditDialog> createState() =>
      _RecurringSeriesEditDialogState();
}

class _RecurringSeriesEditDialogState
    extends ConsumerState<RecurringSeriesEditDialog> {
  ...
  Future<void> _save() async {
    ...
    final updated = s.copyWith(
      ...
      amountUsd: Expense.computeUsd(amount, s.manualFxRateToUsd),
    );
    try {
      await ref
  ...
  Widget build(BuildContext context) {
    ...
    return AlertDialog(
      title: Text(l10n.recurringSeriesEditTitle),
      content: SizedBox(
        width: 400,
